...
void ClapTrap::attack(const std::string& target) {
	...
	if (this->_energyPoints > 0) {
		...
		std::cout << "🥱 Claptrap " << GREEN << this->_name << RED << " has no energy point left to attack.🥱" << RESET << std::endl;
	}
}
